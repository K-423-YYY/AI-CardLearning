...
- AI 加速：文档分析按文件/分块 5 路并行，卡片生成 5 路并发且每批 5 张批量生成，界面显示实时进度
...
单元测试（21 项）覆盖学习区、每日队列、答题判定、错题、复习排期、关卡排版、批量操作、导入导出、设置加密、本地 AI 文件筛选/批量生成与 Word 解析；浏览器端到端测试覆盖手机/桌面布局、Toast 自动消失、离线可用、备份导出和示例备份导入。
