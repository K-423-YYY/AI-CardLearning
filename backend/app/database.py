...
def _ensure_schema_columns(conn: sqlite3.Connection) -> None:
    ...
    _add_column(conn, "daily_tasks", "review_mode", "TEXT NOT NULL DEFAULT 'new'")
    _add_column(conn, "cards", "review_stage", "INTEGER NOT NULL DEFAULT 0")
    _add_column(conn, "cards", "correct_streak", "INTEGER NOT NULL DEFAULT 0")
    _add_column(conn, "cards", "lapse_count", "INTEGER NOT NULL DEFAULT 0")
    _add_column(conn, "cards", "last_review_at", "TEXT")
    _add_column(conn, "cards", "last_wrong_at", "TEXT")
    _add_column(conn, "cards", "last_correct_at", "TEXT")
